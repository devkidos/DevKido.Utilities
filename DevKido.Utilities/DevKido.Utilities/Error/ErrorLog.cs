...
namespace DevKido.Utilities.Error
{
    ...
    public class ErrorLog
    {
        ...
        {
            ExecuteQuery("IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='Error' AND xtype='U')Create TABLE [dbo].[Error]( [ErrorId] [int] IDENTITY(1,1) NOT NULL, [SqlQuery] [nvarchar](max) NULL, [SqlParam] [nvarchar](max) NULL, [CommandType] [nvarchar](max) NULL, [TotalSeconds] [decimal](18, 2) NOT NULL, [Exception] [nvarchar](max) NULL, [InnerException] [nvarchar](max) NULL, [RequestId] [int] NOT NULL, [FileName] [nvarchar](max) NULL,  [MethodName] [nvarchar](100) NULL, [CreateDate] [datetime] NOT NULL, [Active] [bit] NOT NULL, [UserIPAddress] [nvarchar](500) NULL, [UserOS] [nvarchar](200) NULL, [UserLocation] [varchar](max) NULL, [PageName] [varchar](max) NULL, [ErrorType] [nvarchar](100) NULL, [RequestURL] [nvarchar](500) NULL, [UserAgent] [nvarchar](500) NULL, [UserName] [nvarchar](100) NULL, CONSTRAINT [PK_dbo.Error] PRIMARY KEY CLUSTERED ( [ErrorId] ASC )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY] ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]");// +
